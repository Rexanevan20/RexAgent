    ...
    try:
        response = ai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Kamu adalah asisten yang membalas dalam Bahasa Indonesia, singkat dan jelas. Jangan gunakan markdown formatting atau format apapun. Balasan harus plain text aja."
                },
                {
                    "role": "user",
                    "content": pesan_masuk
...
def main():
    ...
    if not AI_API_KEY:
        raise ValueError(
            "AI_API_KEY belum di-set! Tambahin di Railway > Variables."
        )
